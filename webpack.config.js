...
module.exports = {
    ...
    output: {
        ...
        // library means that the exports from the entry file can be accessed from outside, in this case from the global scope as window.RSWikiTranscriber
        library: { type: "umd", name: "RSWikiTranscriber" }
    },
    devtool: false,
    mode: "development",
